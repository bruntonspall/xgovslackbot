  ...
  bot.startConversation(message, function(err,convo) {
    ...
    convo.addQuestion(TOPICS, [
      ...
      },
      {
        pattern: 'invites?',
        callback: function(response, convo) {
          convo.say("To invite someone to this slack, just say invite <email> in this private chat, or mentioned to me in a channel and I'll send an email to them to invite them.\nOnly people on this list: https://github.com/bruntonspall/xgovslackbot/blob/master/app/invite.js will get an invite, you can submit a pull request there to add a domain I don't know about");
          convo.repeat();
          convo.next();
        }
      },
